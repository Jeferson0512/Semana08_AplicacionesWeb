...
public class EmployeeDAOImpl implements EmployeeDAO{
	 ...
	 */
	@Override
	public int create(String pFirstname, String pLastname, Double pSalary, int pAge) {
	 ...
	 */
	@Override
	public void update(int id, String pFirstname, String pLastname, Double pSalary, int pAge) {
